...
interface PegawaiData {
  namaPegawai: string;
  username: string; // Added to store username for navigation
      ...
      k.pegawai.forEach((pegawai) => {
        if (!aggregation[pegawai]) {
          aggregation[pegawai] = {
            ...
            username: pegawai, // Store username for navigation
            jumlahKegiatan: 0,
            targetTotal: 0,
            totalTercapai: 0,
            persentaseSelesai: 0,
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-400">Memuat data kinerja...</p>
      </div>
    );
  }
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="w-24 bg-gray-200 rounded-full h-2.5 dark:bg-gray-600 mr-2">
                      <div
                        className="bg-blue-600 h-2.5 rounded-full dark:bg-blue-500"
                        style={{ width: `${pegawai.persentaseSelesai}%` }}
                      ></div>
                    </div>
